    ...
    <section id="download" className="bg-navy-soft">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-8 text-white md:flex-row">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Apple className="size-6 sm:size-7" />
            <span className="flex flex-col leading-tight">
              <span className="text-[0.625rem] text-white/60 sm:text-xs">Download on the</span>
              <span className="text-sm font-semibold sm:text-base">App Store</span>
            </span>
          </a>
          <a
            href="#download"
          ...
          >
            ...
            <span className="flex flex-col leading-tight">
              <span className="text-[0.625rem] text-white/60 sm:text-xs">Get it on</span>
              <span className="text-sm font-semibold sm:text-base">Google Play</span>
            </span>
          </a>
        </div>
      </div>
